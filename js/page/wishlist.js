...
var wishlistHTML = `<div style="position:relative;" class="container-header">
      <h1 style="font-size:20px;">RoPro ${chrome.i18n.getMessage("TradeOffers")}</h1>
	  ...
	  <span id="offersLoading" style="width: 100px; height: 15px; float:right;display:none;position:absolute;top:8px;right:380px;" class="spinner spinner-default"></span>
	</div>
   <resellers-pane class="ng-isolate-scope">
		...
		<div id="seemore_wishlist" style="display:none;" class="ajax-comments-more-button-container" itemid="387256603" page="0">
                <button type="button" style="width:970px;" class="btn-control-sm rbx-comments-see-more">${chrome.i18n.getMessage("SeeMore")}</button>
            </div>
   </resellers-pane>`
var myInventory = -1
...
function createItem(item, index, noValue) {
	...
	itemHTML = `
	${tooltip}
	<thumbnail-2d id="${parseInt(id)}" rap="${parseInt(rap)}" value="${parseInt(value)}" class="offeritem item-card-thumb-container ng-isolate-scope" style="transform:scale(0.6);margin:-20px;display:inline-block;">
	<a ${href}>
		<span style="width:126px;height:126px;" class="thumbnail-2d-container">
...
if (myUser.toString() == userid) {
	tradeButton = `<button style="position:absolute;left:1010px;top:27px;height:50px;" class="removebutton reseller-purchase-button btn-min-width btn-buy-md ng-binding" onclick="">Remove</button>`
} else {
	tradeButton = `<button style="position:absolute;left:1010px;top:27px;height:50px;" class="trade-with-user reseller-purchase-button btn-min-width btn-buy-md ng-binding" tradesurl="https://www.roblox.com/users/${parseInt(userid)}/trade" onclick="if (this.getAttribute('trades-enabled') == null || this.getAttribute('trades-enabled') == 'true') { window.open('https://www.roblox.com/users/${parseInt(userid)}/trade', '_blank'); }">Trade</button>`
}
offerHTML = `
   <div style="position:relative;height:125px;transform:scale(0.88);margin-left:-65px;margin-bottom:-5px;margin-top:-10px;" class="resale-info">
		  <a class="list-header reseller-item-avatar" ng-href="https://www.roblox.com/users/${parseInt(userid)}/profile" href="https://www.roblox.com/users/${parseInt(userid)}/profile">
			 <div style="margin:auto;margin-left:-10px!important;margin-right:10px!important;" class="user_div">
				<span>
					<img style="margin-left:10px!important;margin-right:10px!important;" class="user_image thumbnail-2d-container ropro-player-thumbnail-${parseInt(userid)}" width="100px" src="${chrome.runtime.getURL('/images/empty.png')}">
				</span>
	   ...
	   <div style="position:absolute;left:630px;bottom:0px;font-size:12px;" class="wantitemrap"><div style="display:inline-block;font-size:12px;margin-right:0px;"></div><div style="height:20px;margin-top:-5px;display: inline-block;">
	   <span style="margin-left:-5px;margin-right:-8px;margin-bottom:0px;transform: scale(0.4);" id="nav-robux" class="icon-robux-28x28 roblox-popover-close"></span>
	   <span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
		<div style="position:absolute;left:260px;bottom:0px;font-size:12px;" class="itemrap"><div style="display:inline-block;font-size:12px;margin-right:0px;"></div><div style="height:20px;margin-top:-5px;display: inline-block;">
		<span style="margin-left:-5px;margin-right:-8px;margin-bottom:0px;transform: scale(0.4);" id="nav-robux" class="icon-robux-28x28 roblox-popover-close"></span>
		<span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
	   ...
	   <div style="margin-right:5px;" class="reseller-price-container"><div style="position:absolute;left:490px;top:0px;width:345px;">
		  <span style="text-align:center;display:block;" class="want">For:</span>
	   </div></div>
	    	   <div style="position:absolute;left:860px;top:0px;width:120px;">
...
offerElement.setAttribute("style", "margin-bottom:20px;")
offerElement.setAttribute("style", "margin-top:0px;padding-top:5px;padding-bottom:5px;position:relative;border-top:none;transform:scale(0.88);margin-left:-65px;margin-bottom:0px;")
offerHTML = `
<div>
   <a class="list-header reseller-item-avatar" ng-href="https://www.roblox.com/users/${parseInt(userid)}/profile" href="https://www.roblox.com/users/${parseInt(userid)}/profile">
         <div style="margin:auto;margin-left:-10px!important;margin-right:10px!important;" class="user_div">
   ...
   <div style="position:absolute;left:260px;bottom:10px;font-size:12px;" class="itemrap"><div style="display:inline-block;font-size:12px;margin-right:0px;"></div><div style="height:20px;margin-top:-5px;display: inline-block;">
   <span style="margin-left:-5px;margin-right:-8px;margin-bottom:0px;transform: scale(0.4);" id="nav-robux" class="icon-robux-28x28 roblox-popover-close"></span>
   <span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
   <div style="position:absolute;left:260px;bottom:-8px;font-size:12px;" class="itemvalue"><div style="margin-top:-5px;display: inline-block;">
   <img style="width:10px;margin-left:4px;" src="${chrome.runtime.getURL('/images/ropro_icon_small.png')}">
   <span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
   <div style="position:absolute;left:635px;bottom:10px;font-size:12px;display:none;" class="wantitemrap"><div style="display:inline-block;font-size:12px;margin-right:0px;"></div><div style="height:20px;margin-top:-5px;display: inline-block;">
	<span style="margin-left:-5px;margin-right:-8px;margin-bottom:0px;transform: scale(0.4);" id="nav-robux" class="icon-robux-28x28 roblox-popover-close"></span>
	<span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
	<div style="position:absolute;left:635px;bottom:-8px;font-size:12px;display:none;" class="wantitemvalue"><div style="margin-top:-5px;display: inline-block;">
	<img style="width:10px;margin-left:4px;" src="${chrome.runtime.getURL('/images/ropro_icon_small.png')}">
	<span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
   <div style="margin-top:0px;" class="resale-info">
	   ...
	   <div style="margin-right:5px;" class="reseller-price-container"> 	   <div style="position:absolute;left:490px;top:0px;width:345px;">
		  <span style="text-align:center;display:block;" class="want">For:</span>
		  			<thumbnail-2d class="item-card-thumb-container ng-isolate-scope" style="transform:scale(0.6);margin:-20px;display:inline-block;">
			<a itemid="${parseInt(pageItemID)}" id="itemContainer5">
				<span style="width:126px;height:126px;" class="thumbnail-2d-container">
				<img class="ng-scope ng-isolate-scope" src="${chrome.runtime.getURL('/images/empty.png')}"/>
				</span>
			</a>
		...
		<div style="position:absolute;left:860px;top:0px;width:120px;">
	      ...
	      <button id="postOfferButton" style="background-color:#0084dd;position:absolute;left:1010px;top:14px;height:80px;" class="reseller-purchase-button btn-min-width btn-buy-md ng-binding" onclick="">Post</button>
   </div>
   </div>
   `
offerElement.innerHTML += offerHTML
...
async function createInventory(container, secondary) {
	...
	div.setAttribute("style", `left:${left}px;bottom:108px;position:absolute;width:300px;height:400px;z-index:10000;padding:15px;`)
	...
	inventoryHTML = `<span style="width:200px;font-weight:bold;font-size:23px;float:left;" class="border-bottom item-name-container">Offer</span><div style="padding-top:0px;margin-top:0px;position:absolute;top:65px;width:270px;height:320px;" class="content"><div id="searchItem" style="margin-top:15px;height:45px;position:relative;">
					<div style="width:260px;margin-left:5px;margin-top:-7px;margin-bottom:0px;" class="input-group"><input autofocus id="searchInventory" class="form-control input-field" type="text" placeholder="Inventory Search" maxlength="120" autocomplete="off" value=""><div class="input-group-btn"><button style="margin:0px;margin-left:2px;" class="input-addon-btn" type="submit"><span class="icon-nav-search"></span></button></div></div>
...
async function createCatalogSearch(container, secondary) {
	...
	div = document.createElement("div")
	div.setAttribute("class", "section-content")
	div.setAttribute("style", `left:${left}px;bottom:108px;position:absolute;width:300px;height:400px;z-index:10;padding:15px;`)
	div.setAttribute("id", "inventorySelector")
	inventoryHTML = `<span style="width:200px;font-weight:bold;font-size:23px;float:left;" class="border-bottom item-name-container">Request</span><div style="padding-top:0px;margin-top:0px;position:absolute;top:65px;width:270px;height:320px;" class="content"><div id="searchItem" style="margin-top:15px;height:45px;position:relative;">
					...
					<div class="input-group"><div><input id="filterSearch" class="form-control input-field new-input-field" placeholder="Item Search" maxlength="120" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value=""></div><div class="input-group-btn"><button style="margin-left:9px;" class="input-addon-btn"><span style="display:none;" class="icon-common-search-sm"></span></button></div></div>
...
function wishlistMain() {
	...
	wishlist.setAttribute("style", "width:970px;margin:auto;")
