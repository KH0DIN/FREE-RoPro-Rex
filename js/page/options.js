...
function getSubscription(userID) {
	return new Promise(resolve => {
		async function doGet(resolve) {
			...
			$.post({url: "https://ropro-proxy.deno.dev/getSubscription.php///api?key=" + await getStorage("subscriptionKey") + "&options_page", headers: {'ropro-verification': roproVerificationToken, 'ropro-id': userID}}, function(data){
