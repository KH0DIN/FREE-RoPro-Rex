...
async function addVideoThemeCard(theme) {
	...
	$(card).mouseenter(function() {
		var div = document.createElement('div')
		div.innerHTML = `<video src="https://api.ropro.io/themes/v2/thumbnails/${stripTags(theme['name'])}" autoplay="" muted="" loop="" style="height:100%;border-radius:10px;position:absolute;top:0;left:0;"></video>`
