...
if (myUser.toString() == userid) {
	tradeButton = `<button style="position:absolute;left:1010px;top:40px;height:50px;" class="removebutton reseller-purchase-button btn-min-width btn-buy-md ng-binding" onclick="">Remove</button>`
} else {
	tradeButton = `<button style="position:absolute;left:1010px;top:40px;height:50px;" tradesurl="https://www.roblox.com/users/${parseInt(userid)}/trade" class="trade-with-user reseller-purchase-button btn-min-width btn-buy-md ng-binding" onclick="if (this.getAttribute('trades-enabled') == null || this.getAttribute('trades-enabled') == 'true') { window.open('https://www.roblox.com/users/${parseInt(userid)}/trade', '_blank'); }">Trade</button>`
}
offerHTML = `
...
offerHTML = `
   ...
   <div style="position:absolute;left:260px;bottom:30px;font-size:12px;" class="itemrap"><div style="display:inline-block;font-size:12px;margin-right:0px;"></div><div style="height:20px;margin-top:-5px;display: inline-block;">
   <span style="margin-left:-5px;margin-right:-8px;margin-bottom:0px;transform: scale(0.4);" id="nav-robux" class="icon-robux-28x28 roblox-popover-close"></span>
   <span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
   ...
   <div style="margin-top:0px;" class="resale-info">
	   ...
	   <div style="margin-right:5px;" class="reseller-price-container"> 	   <div style="position:absolute;left:490px;top:0px;width:345px;">
		...
		<div style="position:absolute;left:860px;top:0px;width:120px;">
	      ...
	      <button id="postOfferButton" style="background-color:#0084dd;position:absolute;left:1010px;top:25px;height:80px;" class="reseller-purchase-button btn-min-width btn-buy-md ng-binding" onclick="">Post</button>
   </div>
   `
offerElement.innerHTML += offerHTML
return offerElement
